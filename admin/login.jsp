...
<%@page import="net.kuanda.Setting"%>
<%@page import="net.kuanda.util.SettingUtils"%>
<%@page import="net.kuanda.util.SpringUtils"%>
<%@page import="net.kuanda.Setting.CaptchaType"%>
<%@page import="net.kuanda.Setting.AccountLockType"%>
<%@page import="net.kuanda.service.RSAService"%>
...
%>
<title><%=SpringUtils.getMessage("admin.login.title")%> - Powered By kuanda</title>
			...
			<form id="loginForm" action="login.jsp" method="post">
				...
				<table>
					<tr>
						...
						<td>
							<input type="text" id="username" name="username" class="text" maxlength="20" value="admin2"/>
						</td>
					</tr>
					<tr>
						<th>
						...
						<td>
							<input type="password" id="password" class="text" maxlength="20" autocomplete="off" value="123456"/>
						</td>
					</tr>
					<%if (ArrayUtils.contains(setting.getCaptchaTypes(), CaptchaType.adminLogin)) {%>
						<tr>
					...
					<tr>
						...
						<td>
							...
							&nbsp;&nbsp;<a href="<%=base%>/register_facotry/find_admin.jhtml"><%=SpringUtils.getMessage("shop.login.findPassword")%></a>
						</td>
					</tr>
					<tr>
						<td>
				...
				<div class="powered">COPYRIGHT © 2005-2013 kuanda.NET ALL RIGHTS RESERVED.</div>
				<div class="link">
					<a href="<%=base%>/"><%=SpringUtils.getMessage("admin.login.home")%></a> |
					<a href="http://www.kuanda.net"><%=SpringUtils.getMessage("admin.login.official")%></a> |
					<a href="http://www.kuanda.net/about.html"><%=SpringUtils.getMessage("admin.login.about")%></a> |
					<a href="http://www.kuanda.net/contact.html"><%=SpringUtils.getMessage("admin.login.contact")%></a> |
					<a href="http://www.kuanda.net/license.html"><%=SpringUtils.getMessage("admin.login.license")%></a>
				</div>
			</form>
		</div>
