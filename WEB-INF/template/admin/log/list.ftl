...
<title>${message("admin.log.list")} - Powered By kuanda</title>
	...
	<form id="listForm" action="list.jhtml" method="get">
		...
		<table id="listTable" class="list">
			<tr>
				...
				<th>
					<a href="javascript:;" class="sort" name="id_mName">关联商户（ID,名称）</a>
				</th>				
				<th>
			...
			[#list page.content as log]
				<tr>
					<td>
						<input type="checkbox" name="ids" value="${log.id}" [#if admin.username != "admin"] disabled="disabled" [/#if] />
					</td>
					<td>
						${log.operation}
					</td>
