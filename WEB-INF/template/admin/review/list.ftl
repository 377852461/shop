...
<title>${message("admin.review.list")} - Powered By kuanda</title>
	...
	<form id="listForm" action="list.jhtml" method="get">
		...
		<table id="listTable" class="list">
			<tr>
				...
				<th>
					<a href="javascript:;" class="sort" name="score">${message("Review.productScore")}</a>
				</th>
				<th>
					<a href="javascript:;" class="sort" name="score">${message("Review.corpScore")}</a>
				</th>
				<th>
					<a href="javascript:;" class="sort" name="score">${message("Review.customerScore")}</a>
				</th>
				<th>
