...
<title>${message("admin.admin.list")} - Powered By kuanda</title>
				...
				<tr>
					<td>
						<input type="checkbox" name="ids" value="${a.id}" 
							...
							[#if a.factory?? ]
								[#if  !admin.factory?? || a.factory.id != admin.factory.id ]
									disabled="disabled"
								[#elseif a.id == admin.id]
									disabled="disabled"
								[/#if]
							[#elseif a.id == admin.id ]
								disabled="disabled"
					...
					<td>
						[#if a.loginDate??]
							<span title="${a.loginDate?string("yyyy-MM-dd HH:mm:ss")}">${a.loginDate}</span>
						[#else]
							-
						[/#if]
					</td>
					...
					<td>
						<span title="${a.createDate?string("yyyy-MM-dd HH:mm:ss")}">${a.createDate}</span>
					</td>
					<td>
						[#if a.factory?? ]
							[#if  admin.factory?? && admin.factory.id == a.factory.id  ]
							<a href="edit.jhtml?id=${a.id}">[${message("admin.common.edit")}]</a>
							[#else]
								--
							[/#if]
						[#else]
