...
<title>${message("admin.admin.add")} - Powered By kuanda</title>
...
$().ready(function() {
	...
	var $employeeMessage = $("#employeeMessage"); 
	var $factoryMessage = $("#factoryMessage");

	$employeeId.change(function(){
		$employeeMessage.val($employeeId.val()*1+$factoryId.val()*1);
		$factoryMessage.val($employeeId.val()*1+$factoryId.val()*1);
	});
	...
	$inputForm.validate({
		...
		messages: {
			...
			factoryMessage:"必须选择商户或者员工",
			employeeMessage:"必须选择商户或者员工"
		}
	});
...
<body>
	...
	<form id="inputForm" action="save.jhtml" method="post">
		...
		<table class="input tabContent">
			...
			<tr>
				<th>
					${message("admin.admin.factory")}:
				</th>
				<td>
					<select id="factoryId" name="factoryId">
						<option value="0">${message("admin.common.choose")}</option>
					...
					<input type="hidden" id="factoryMessage" name="factoryMessage" value="0" >
				</td>
			</tr>
			<tr>
				<th>所属员工:</th>
				<td>
					...
					<input type="hidden" id="employeeMessage" name="employeeMessage" value="0" >
				</td>
			</tr>			
			<tr class="roles">
				<th>
