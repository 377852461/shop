	...
	$inputForm.validate({
		rules: {
			...
			sn: {
				pattern: /^[0-9a-zA-Z_-]+$/,
				remote: {
					url: "${base}/admin/exchange/check_sn.jhtml",
					cache: false
				}
			},
			price: {
...
<body>
	...
	<form id="inputForm" action="save.jhtml" method="GET" enctype="multipart/form-data">
		<ul id="tab" class="tab">
			<li>
		...
		<table class="input tabContent">
			...
			<tr>
				...
				<td>
					<input type="text" name="brand" class="text" maxlength="200" />
				</td>
			</tr>
			<tr>
				<th>
		...
		<table class="input tabContent">
			<tr>
				<td>
					<textarea name="shortIntroduction" style="width:100%;height:200px;visibility:hidden;"></textarea>
				</td>
			</tr>
			<tr>
				<td>
