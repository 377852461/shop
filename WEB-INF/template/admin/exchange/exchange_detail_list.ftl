...
<body>
	<div class="path">
		<a href="${base}/admin/common/index.jhtml">${message("admin.path.index")}</a> &raquo; ${message("admin.exchange.list")} <span>(${message("admin.page.total", page.total)})</span>
	</div>
	<form id="listForm" action="list.jhtml" method="get">
			...
			<!--<div class="menuWrap">
				...
				<div class="popupMenu">
					<ul id="searchPropertyOption">
						<li>
							<a href="javascript:;"[#if page.searchProperty == "name"] class="current"[/#if] val="username">${message("exchange.member")}</a>
						</li>
						<li>
							<a href="javascript:;"[#if page.searchProperty == "type"] class="current"[/#if] val="linkName">${message("exchange.type")}</a>
						</li>
					</ul>
				</div>
			</div>-->
		...
		<table id="listTable" class="list">
			<tr>
				...
				<th>
					<a href="javascript:;" class="sort" name="pName">${message("exchange.member")}</a>
				</th>
				<th>
					<a href="javascript:;" class="sort" name="createDate">${message("exchange.createDate")}</a>
				</th>
				<th>
					<a href="javascript:;" class="sort" name="type">${message("exchange.type")}</a>
				</th>
				<th>
					<a href="javascript:;" class="sort" name="beforePoint">${message("exchange.beforePoint")}</a>
				</th>
				<th>
					<a href="javascript:;" class="sort" name="point">${message("exchange.point")}</a>
				</th>
				<th>
					<a href="javascript:;" class="sort" name="afterPoint">${message("exchange.afterPoint")}</a>
				</th>
			</tr>
				[#list page.content as point]
					<tr>
						<td>
							<input type="checkbox" name="ids" value="${point.id}" />
						</td>
						<td>
							${point.member.username}
						</td>
						<td>
						...
						<td>
							[#if point.type=="0"]
								${message("admin.exchange.coupon")}
							[#elseif point.type=="1"]
								${message("admin.exchange.product")}
							[/#if]
						</td>
						<td>
							${point.before_point}
