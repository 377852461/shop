...
<title>${message("admin.productCategory.list")} - Powered By kuanda</title>
		...
		<div class="bar">
			...
			<div class="menuWrap">
				<div class="search">
					...
					<input type="text" id="searchValue" name="factoryName" value="${page.searchValue}" maxlength="200" />
					<button type="submit">&nbsp;</button>
				</div>
				<div class="popupMenu">
					<ul id="searchPropertyOption">
						<li>
							<a href="javascript:;" val="factoryId">${message("Product.name")}</a>
						</li>
					</ul>
				</div>
			</div>
