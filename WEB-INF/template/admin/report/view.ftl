			...
			<tr>
				...
				<td>
					<select id="productCategoryID" name="productCategoryID">
						[#list productCategorys as salesProductCategory]
							<option value="${salesProductCategory.id}"[#if salesProductCategory.id == productCategoryID] selected="selected"[/#if]>${salesProductCategory.name}</option>
						[/#list]
					</select>
				</td>
			</tr>
