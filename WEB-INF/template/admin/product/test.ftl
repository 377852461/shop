...
<script type="text/javascript" src="${base}/resources/admin/editor/kindeditor-min.js" charset="utf-8"></script>
	...
	<form id="inputForm" action="save.jhtml" method="post" enctype="multipart/form-data">
		...
		<table class="input tabContent">
			...
			<tr>
				...
				<td>
					<span class="fieldSet">
						<input type="text" name="groupImage" class="text" maxlength="200" title="${message("admin.product.imageTitle")}" />
		...
		<table class="input tabContent">
			<tr>
				<td>
					<textarea id="editor"  name="introduction" class="editor" style="width:70%;height:200px;visibility:hidden;"></textarea>
				</td>
			</tr>
		</table>
		<table class="input tabContent">
			<tr>
				<td>
					<textarea  name="shortIntroduction"  style="width: 100%;"></textarea>
				</td>
			</tr>
			<tr>
				<td>
