	...
	<form id="inputForm" action="save.jhtml" method="post" enctype="multipart/form-data">
		...
		<table class="input tabContent">
			...
			<tr>
				...
				<td>
					<span class="fieldSet">
						<input type="text" name="groupImage" class="text" maxlength="200" title="用于团购展示图片" />
			...
			<tr id="storeCategoryTr">
				...
				<td>
					<div id="storeCategoryIdBank"></div>
					<label id="storeCategoryShow"></label>
			...
			<tr>
				...
				<td>
					<input type="text" name="rakeBack" class="text" maxlength="3" value="80"/>
				</td>
			</tr>
			<tr>
				<th>
		...
		<table class="input tabContent">
			<tr>
				<td>
					<textarea  name="shortIntroduction" style="width:70%;height:200px;visibility:hidden;"></textarea>
				</td>
			</tr>
			<tr>
				<td>
		...
		<!--<table class="input tabContent">
			<tr>
				<td>
					<textarea id="editor3"  name="productSource" class="editor" style="width: 100%;"></textarea>
				</td>
			</tr>
		</table>-->
