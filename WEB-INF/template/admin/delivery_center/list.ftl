...
<title>${message("admin.deliveryCenter.list")} - Powered By kuanda</title>
	...
	<form id="listForm" action="list.jhtml" method="get">
		...
		<table id="listTable" class="list">
			<tr>
				...
				<th>
					<a href="javascript:;" class="sort" name="factory">${message("DeliveryCenter.factory")}</a>
				</th>
				<th>
			...
			[#list page.content as deliveryCenter]
				[#if (admin.factory)??]
					[#if deliveryCenter.factory==admin.factory]
						<tr>
							<td class="check">
