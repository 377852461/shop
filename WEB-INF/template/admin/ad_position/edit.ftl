...
<title>${message("admin.adPosition.edit")} - Powered By kuanda</title>
	...
	<form id="inputForm" action="update.jhtml" method="post">
		...
		<table class="input">
			...
			<tr>
				<th>是否为店中店：</th>
				<td> 
					[#if adPosition.isStore ]
						<input type="radio"  name="isStore" value="true" checked="checked" >是
						<input type="radio"  name="isStore" disabled="disabled" >否
					[#else]
						<input type="radio"  name="isStore" value="true" disabled="disabled" >是
						<input type="radio"  name="isStore" value="false" checked="checked" >否
				 	[/#if]
				 </td>
			</tr>
			[#if !adPosition.isStore]
			<tr>
				...
				<td> 
					<label>
						<input type="checkbox" name="isApply" value="true" [#if adPosition.isApply] checked="checked"[/#if] />可申请申请广告
						<input type="hidden" name="_isApply" value="false" />
					</label>
				 </td>
			</tr>
			[/#if]
