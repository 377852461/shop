...
<title>${message("admin.adPosition.list")} - Powered By kuanda</title>
	...
	<form id="listForm" action="list.jhtml" method="get">
		...
		<table id="listTable" class="list">
			...
			[#list page.content as adPosition]
				<tr>
					<td>
						[#if !adPosition.isStore]<input type="checkbox" name="ids" value="${adPosition.id}" />[/#if]
					</td>
					<td>
						${adPosition.name}
					</td>
					...
					<td>
						<span class="${adPosition.isApply?string("true", "false")}Icon">&nbsp;</span>
					</td>
					<td>
