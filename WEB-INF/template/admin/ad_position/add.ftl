...
<title>${message("admin.adPosition.add")} - Powered By kuanda</title>
	...
	<form id="inputForm" action="save.jhtml" method="post">
		<table class="input">
			...
			<tr>
				<th>是否为店中店：</th>
				<td> 
					是<input type="radio"  name="isStore" value="true" >
					否<input type="radio"  name="isStore" value="false" checked="checked" >
				 </td>
			</tr>
			<tr>
				<th>
