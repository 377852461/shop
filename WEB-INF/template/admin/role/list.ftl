...
<title>${message("admin.role.list")} - Powered By kuanda</title>
...
<body>
	...
	<form id="listForm" action="list.jhtml" method="get">
		...
		<table id="listTable" class="list">
			<tr>
				<th class="check">
					<input type="checkbox" id="selectAll" [#if role.factory?? || !admin.factory?? || admin.factory.id != role.factory.id ] disabled="disabled" [/#if]  />
				</th>
				<th>
			...
			[#list page.content as role]
				<tr>
					<td>
						<input type="checkbox" name="ids"[#if role.isSystem] title="${message("admin.role.deleteSystemNotAllowed")}" disabled="disabled"[#else] 
						
							[#if role.factory?? ]
								[#if  !admin.factory?? || role.factory.id != admin.factory.id ]
									disabled="disabled"
								[/#if]
							[/#if]
						value="${role.id}"[/#if] />
					...
					<td>
						[#if role.factory?? ]
							[#if  admin.factory?? && admin.factory.id == role.factory.id  ]
