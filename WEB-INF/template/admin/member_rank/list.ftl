...
<title>${message("admin.memberRank.list")} - Powered By kuanda</title>
		...
		<table id="listTable" class="list">
			...
			[#if memberRank.id=5]
				<tr style="color:red;">
					...
					<td>
						<a href="edit.jhtml?id=${memberRank.id}" style="color:red;">[${message("admin.common.edit")}]</a>
						<a href="${base}/article/content/201408/2/1.html" style="color:red;" target="_blank">[${message("admin.common.view")}]</a>
					</td>
				</tr>
			[#else]
				<tr>
					...
					<td>
						...
						<a href="${base}/article/content/201408/2/1.html" target="_blank">[${message("admin.common.view")}]</a>
					</td>
				</tr>
			[/#if]
			[/#list]
