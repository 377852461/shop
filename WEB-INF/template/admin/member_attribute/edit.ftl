...
<title>${message("admin.memberAttribute.edit")} - Powered By kuanda</title>
		...
		<table id="memberAttributeTable" class="input">
			...
			<tr>
				...
				<td>
					...
					<label>
						<input type="checkbox" name="isShow" value="true"[#if memberAttribute.isShow] checked="checked"[/#if] />${message("MemberAttribute.isShow")}
