...
<title>${message("admin.promotion.add")} - Powered By kuanda</title>
		...
		<div class="tabContent">
			<table class="input">
				...
				<!--<tr>
					...
					<td colspan="2">
						<label>
							<input type="checkbox" name="isFreeShipping" value="true" checked="checked" />${message("Promotion.isFreeShipping")}
