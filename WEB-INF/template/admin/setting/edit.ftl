...
<title>${message("admin.setting.edit")} - Powered By kuanda</title>
...
$().ready(function() {
	...
	var $dataBaseBackupStatus = $("#dataBaseBackupStatus");
	...
	<form id="inputForm" action="update.jhtml" method="post" enctype="multipart/form-data">
		...
		<table class="input tabContent">
			...
			<tr>
				...
				<td>
					<input type="text" name="ww" class="text" value="${setting.ww}" maxlength="200" />
				</td>
			</tr>
		...
		<table class="input tabContent">
			...
			<tr>
				<th>
					<span class="requiredField">*</span>${message("Setting.registerFactoryAgreement")}:
				</th>
				<td>
					<textarea name="registerFactoryAgreement" class="text">${setting.registerFactoryAgreement?html}</textarea>
				</td>
			</tr>
			<tr>
				<th>
		...
		<table class="input tabContent">
			<tr>
				<th>
					<span class="requiredField">*</span>备份路径: 
				</th>
				<td>
					<input type="text" name="dataBaseBackup" class="text" value="${setting.dataBaseBackup}" maxlength="200" />
				</td>
			</tr>
			<tr>
				<th>
				...
				<td>
					<input type="button" id="dataBaseBackup" class="button" value="开始备份" />(请确保mysql安装路径不包含任何空格)
					<span id="dataBaseBackupStatus">&nbsp;</span>
				</td>
			</tr>
		</table>
		<table class="input">
