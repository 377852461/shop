...
<title>${message("admin.index.title")} - Powered By kuanda</title>
...
<body>
	...
	<table class="input">
		...
		<tr>
			...
			<td>
				<a href="http://www.kuanda.net" target="_blank">http://www.kuanda.net</a>
			</td>
			<th>
				${message("admin.index.bbs")}:
			</th>
			<td>
				<a href="http://bbs.kuanda.net" target="_blank">http://bbs.kuanda.net</a>
			</td>
		</tr>
		<tr>
			<td colspan="4">
