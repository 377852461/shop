...
<title>${message("admin.order.edit")} - Powered By kuanda</title>
			...
			[#list order.orderItems as orderItem]
				<tr class="orderItemTr">
					<td>
						...
						<input type="hidden" name="orderItems[${orderItem_index}].totalPrice" value="${orderItem.totalPrice}" />
						<input type="hidden" name="orderItems[${orderItem_index}].returnQuantity" value="${orderItem.returnQuantity}" />
						<input type="hidden" name="orderItems[${orderItem_index}].shippedQuantity" value="${orderItem.shippedQuantity}" />
