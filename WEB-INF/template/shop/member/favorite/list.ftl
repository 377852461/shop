...
<title>${message("shop.member.favorite.list")}[#if systemShowPowered] - Powered By kuanda[/#if]</title>
					...
					[#list page.content as product]
						<tr[#if !product_has_next] class="last"[/#if]>
							<td>
								...
								<a href="${base}${product.path}"><img src="[#if product.thumbnail??]${product.thumbnail}[#else]${setting.defaultThumbnailProductImage}[/#if]" class="thumbnail" alt="${product.name}" /></a>
							</td>
							<td>
								${product.sn}
							</td>
