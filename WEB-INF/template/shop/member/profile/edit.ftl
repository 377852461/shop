...
<title>${message("shop.member.profile.edit")}[#if systemShowPowered] - Powered By kuanda[/#if]</title>
				...
				<form id="inputForm" action="update.jhtml" method="post">
					<table class="input">
						<tr>
							...
							<td>
								<input type="text" name="email" value="${member.email}" style='border-left:0px;border-top:0px;border-right:0px;border-bottom:1px;'/>
							</td>
						</tr>
						[#list memberAttributes as memberAttribute]
							<tr>
								...
								<td>
									...
									[#elseif memberAttribute.type == "sign"]
										<input type="text" name="memberAttribute_${memberAttribute.id}" class="text" value="${member.sign}"/>
