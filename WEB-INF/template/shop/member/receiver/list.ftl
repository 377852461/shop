...
<title>${message("shop.member.receiver.list")}[#if systemShowPowered] - Powered By kuanda[/#if]</title>
			...
			<div class="list">
				...
				<table id="listTable" class="list">
					...
					[#list page.content as receiver]
						<tr [#if !receiver_has_next] class="last"[/#if] [#if receiver.isDefault=='true'] style="color:red;" [/#if]>
							<td>
							...
							<td>
								...
								<a href="default.jhtml?id=${receiver.id}">[${message("shop.member.handle.default")}]</a>
								[/#if]
