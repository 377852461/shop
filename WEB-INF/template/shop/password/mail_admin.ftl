...
<body>
	...
	<p>
		<a href="${setting.siteUrl}/register_facotry/reset.jhtml?username=${username}&key=${safeKey.value}" target="_blank">${setting.siteUrl}/register_facotry/reset.jhtml?username=${username}&key=${safeKey.value}</a>
	</p>
