...
<div class="container header">
	...
	<div class="span10 last">
		...
		[/#if]
		<div>
			<a target="_blank" href="http://wpa.qq.com/msgrd?v=3&uin=${setting.qq}&site=qq&menu=yes"><img border="0" src="http://wpa.qq.com/pa?p=2:${setting.qq}:51" alt="点击这里给我发消息" title="点击这里给我发消息"/></a>
			<a target="_blank" href="http://www.taobao.com/webww/ww.php?ver=3&touid=${setting.ww}&siteid=cntaobao&status=1&charset=utf-8"><img border="0" src="http://amos.alicdn.com/online.aw?v=2&uid=${setting.ww}&site=cntaobao&s=1&charset=utf-8" alt="点这里给我发消息" /></a>
		</div>
	</div>
	<div class="span24">
		<ul class="mainNav">
