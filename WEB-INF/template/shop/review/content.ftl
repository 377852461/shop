		...
		<div class="span18 last">
			...
			<table class="info">
				...
				[#if product.scoreCount > 0]
					<tr>
						<td>
							<div>${message("Review.productScore")}: </div>
							<div class="score${(product.score * 2)?string("0")}"></div>
							<div>${product.score?string("0.0")}</div>
						</td>
					</tr>
					<tr>
						<td>
							<div>${message("Review.corpScore")}: </div>
							<div class="score${(product.corpScore * 2)?string("0")}"></div>
							<div>${product.corpScore?string("0.0")}</div>
						</td>
					</tr>
					<tr>
						<td>
							<div>${message("Review.customerScore")}: </div>
							<div class="score${(product.customerScore * 2)?string("0")}"></div>
							<div>${product.customerScore?string("0.0")}</div>
						</td>
					</tr>
				[#else]
					<tr>
