...
<title>${message("admin.plugin.unionpay.setting")} - Powered By kuanda</title>
...
<body>
	...
	<form id="inputForm" action="update.jhtml" method="post">
		<table class="input">
			...
			<tr>
				<th>
					<span class="requiredField">*</span>${message("admin.plugin.chinapay.partner")}:
				</th>
				<td>
			...
			<tr>
				<th>
					<span class="requiredField">*</span>${message("admin.plugin.chinapay.keypath")}:
				</th>
				<td>
					<input type="text" name="keypath" class="text" value="${pluginConfig.attributes.get("keypath")}" maxlength="200" />
				</td>
			</tr>
			<tr>
				<th>
					<span class="requiredField">*</span>${message("admin.plugin.chinapay.prk1")}:
				</th>
				<td>
					<input type="text" name="prk1" class="text" value="${pluginConfig.attributes.get("prk1")}" maxlength="200" />
				</td>
			</tr>
			<tr>
				<th>
					<span class="requiredField">*</span>${message("admin.plugin.chinapay.path")}:
				</th>
				<td>
					<input type="text" name="path" class="text" value="${pluginConfig.attributes.get("path")}" maxlength="200" />
				</td>
			</tr>
			<tr>
				<th>
